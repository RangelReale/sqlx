...
func (s *sqlDBWrapper) QueryContext(ctx context.Context, query string, args ...interface{}) (SQLRows, error) {
	return s.db.QueryContext(ctx, query, args...)
}

func (s *sqlDBWrapper) QueryRow(query string, args ...interface{}) SQLRow {
	return s.db.QueryRow(query, args...)
}

func (s *sqlDBWrapper) QueryRowContext(ctx context.Context, query string, args ...interface{}) SQLRow {
	return s.db.QueryRowContext(ctx, query, args...)
}

func (s *sqlDBWrapper) Exec(query string, args ...interface{}) (sql.Result, error) {
...
func (s *sqlStmtWrapper) Query(args ...interface{}) (SQLRows, error) {
	return s.stmt.Query(args...)
}

func (s *sqlStmtWrapper) QueryContext(ctx context.Context, args ...interface{}) (SQLRows, error) {
	return s.stmt.QueryContext(ctx, args...)
}

func (s *sqlStmtWrapper) QueryRow(args ...interface{}) SQLRow {
	return s.stmt.QueryRow(args...)
}

func (s *sqlStmtWrapper) QueryRowContext(ctx context.Context, args ...interface{}) SQLRow {
	return s.stmt.QueryRowContext(ctx, args...)
}

func (s *sqlStmtWrapper) Exec(args ...interface{}) (sql.Result, error) {
	return s.stmt.Exec(args...)
}

func (s *sqlStmtWrapper) ExecContext(ctx context.Context, args ...interface{}) (sql.Result, error) {
...
func (s *sqlTxWrapper) Query(query string, args ...interface{}) (SQLRows, error) {
	return s.tx.Query(query, args...)
}

func (s *sqlTxWrapper) QueryContext(ctx context.Context, query string, args ...interface{}) (SQLRows, error) {
	return s.tx.QueryContext(ctx, query, args...)
}

func (s *sqlTxWrapper) QueryRow(query string, args ...interface{}) SQLRow {
	return s.tx.QueryRow(query, args...)
}

func (s *sqlTxWrapper) QueryRowContext(ctx context.Context, query string, args ...interface{}) SQLRow {
	return s.tx.QueryRowContext(ctx, query, args...)
}

func (s *sqlTxWrapper) Exec(query string, args ...interface{}) (sql.Result, error) {
